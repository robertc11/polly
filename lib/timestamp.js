...
export function timeAgo(originalTime){
    ...
    if(difference >= 31556926){
        // greater than a year
        return Math.round(difference/31556926)+" years"
    }else if(difference >= 2629743){
        // greater than a month but less than a year
        return Math.round(difference/2629743)+" months"
    }else if(difference >= 604800){
        return Math.round(difference/604800)+" weeks"
    }else if(difference >= 86400){
        return Math.round(difference/86400)+" days"
    }else if(difference >= 3600){
        return Math.round(difference/3600)+" hours"

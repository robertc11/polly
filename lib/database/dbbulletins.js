...
export async function runner(funcName,options){
    ...
    //console.log('this is mongoclient', client)
    ...
    try{
        ...
        logger.error(['> dbbulletins.js/runner: An unexpected error occurred', err.name, err.message, err.cause])
        return {
            success: false,
            error: err,
        }
...
async function getBulletins(client, cityid, uid, per_page, objID){
    ...
    try{
        ...
        logger.error(['> dbbulletins.js/getBulletins: ERROR', err.name, err.message, err.cause])
        return {
            success: false,
            resdb: null,
            error: true
...
async function setVotes(client,postid=null,uid=null,vote=null,adjustmentup=null,adjustmentdown=null){
    ...
    try{
        ...
        logger.error(['> dbbulletins/setVotes: ERROR:', err.name, err.message, err.cause])
...
async function createBulletin(client, upvotes=null, downvotes=null, statement=null, map=null, mapLink=null, city=null, timestamp=null, body=null, anon=null, attachments=[], user){
    ...
    try{
        ...
        logger.error('> dbbulletins/createBulletin: creating a new post in dbbulletins failed!')
...
async function removeBulletin(client, posttodelete){
    ...
    try{
        ...
        logger.error(['> dbbulletins/removeBulletin:',err.name, err.message, err.cause])
...
async function getOneBulletin(client, postID, uid){
    ...
    try{
        ...
        logger.error(['> dbbulletins/getOneBulletin:',err.name, err.message, err.cause])
...
async function updateBulletin(client, postID, newTitle, newMap, newMapLink, newBody, newAnon, newFilenames){
    ...
    try{
        ...
        logger.error(['> dbbulletins/updateBulletin:',err.name, err.message, err.cause])
...
async function addComment(client, bulletinID, commentBody, authorID, authorName, timestamp){
    ...
    try{
        ...
        logger.error(['> dbbulletins/addComment:',err.name, err.message, err.cause])
...
async function getComments(client, postid, perpage, objid){
    ...
    try{
        ...
        logger.error(['> dbbulletins.js/getComments: ERROR', err.name, err.message, err.cause])
        return {
            success: false,
            resdb: null,
            error: true

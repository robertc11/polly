...
export async function runner(funcName,options){
    ...
    try{        
        ...
        logger.error(['> dbusers.js/runner: An unexpected error occurred', err])
        return {
            success: false,
            error: err,
        }
...
async function createUser(client,first,last,email,phone,street,city,state,zip,user,pass){
    ...
    try{
        ...
        logger.error(['> dbusers.js/createUser: An unexpected error occurred:', err])
        return {
            success: false,
            error: err,
        }
...
async function validateInfo(client,usernameInput){
    ...
    try{
        ...
        logger.error(['> dbusers.js/validateInfo: USER NOT FOUND:', err])
...
async function validateUsername(client,usernameInput){
    ...
    try{
        ...
        logger.error(['> dbusers.js/validateUsername: An unexpected error occurred:', err])
        return {
            success: false,
            error: err,
        }
...
async function getAddress(client, uid){
    ...
    try{
        ...
        logger.error(['> dbusers.js/getAddress: ERROR:', err])
        return {
            success: false,
            error: err,
        }
...
async function getEmail(client, uid){
    ...
    try{
        ...
        logger.error(['> dbusers.js/getEmail: ERROR:', err])
        return {
            success: false,
            error: err,
        }
...
async function deleteUser(client, uid){
    ...
    try{
        ...
        logger.error(['> dbusers.js/deleteUser: ERROR:', err])
        return {
            success: false,
            error: err,
        }
...
async function editPassword(client, uid, password){
    ...
    try{
        ...
        logger.error(['> dbusers.js/editPassword: ERROR:', err])
        return {
            success: false,
            error: err,
        }

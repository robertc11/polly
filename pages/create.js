...
export default function CreatePostPage({ user }){
    ...
    const handleSubmit = async (e) => {
        ...
        body.append('upvotes',1)
        body.append('downvotes',0)
        ...
        body.append('city',user.cityID[3])
        body.append('timestamp',getCurrentUnix())
        body.append('body',e.currentTarget.textContent.value)
        body.append('anonymous',isAnon)
        for(let i=0; i<stagedFiles.length; i++){
            body.append(`file_${i}`, stagedFiles[i].file_data)
        }
        ...
        <>
            ...
            <div className="bg-[#f5f5f5] min-h-screen min-w-screen">
                <div className="relative pb-10 pt-10">
                    ...
                    <h1 className="text-center font-dongji text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-indigo-500 mb-10 z-10">Your Shiny New Post</h1>
                    <div className="border border-gray-300 w-7/12 mx-auto py-10 shadow-lg rounded-lg bg-white">
                        <form onSubmit={handleSubmit} className="flex flex-col">
                            ...
                            <div className="w-10/12 mx-auto flex flex-row-reverse items-center mt-3 mb-10 text-slate-600">
                                <button id="submitnewpost" type="submit" className="w-1/6 mt-3 px-1 py-2 bg-violet-500 mr-1 ml-3 text-white rounded">Create!</button>

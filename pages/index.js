    ...
    render(){
        return (
            <>
                ...
                <div id="mainBlock" className="rounded-lg flex flex-col justify-center items-center mx-auto w-2/3 mb-10 px-5 py-52 font-dongji">
                ...
                <div id="introBlock" className="bg-violet-50 w-full mb-10 font-dongji">
                    <div className="flex w-2/3 mx-auto">
                        ...
                        <div className="text-slate-600 w-1/2 px-10 py-20 mx-auto text-left">
                            <h1 className="text-5xl font-bold mb-10"><span className="block">Stay informed</span> on local elections <span className="block text-violet-500">anywhere</span></h1>
                ...
                <div id="cardsBlock" className="w-full p-5 font-dongji mb-10">
                    <div className="flex w-2/3 mx-auto">
                        <div className="text-slate-600 w-1/2 px-10 py-20 mx-auto text-left">
                            <h1 className="text-5xl font-bold mb-10">Learn more about <span className="block">your <span className="text-violet-500">politicians</span></span></h1>
                            <li className="list-none">
                                <ul className="w-full mb-10">
                                    <div className="flex">
                                        <div className='h-full mt-1'>
                ...
                <div id="bulletinBlock" className="bg-violet-50 w-full mb-10 font-dongji">
                    <div className="flex w-2/3 mx-auto">
                        ...
                        <div className="text-slate-600 w-1/2 px-10 py-20 mx-auto text-left">
                            <h1 className="text-5xl font-bold mb-10"><span className="block">Work together</span> to <span className="text-violet-500">improve</span> your <span className="block">community</span></h1>
                            <li className="list-none">
                                <ul className="w-full mb-10">
                                    <div className="flex">
                                        <div className='h-full mt-1'>

        ...
        return (
            <>
                ...
                <div id="bulletinBlock" className="rounded-lg flex flex-col justify-center items-center mx-auto shadow-lg bg-violet-100 w-2/3 p-5 font-dongji mb-10">
                    ...
                    <BulletinRow up={42} down={12} statement={"Neighbors want to Fix the Pothole on 5th and Main"} quotes={[{comment:'Apart from being a hazard to pedestrians, the pothole can cause damage to my car!',poster: 'Diane P.'},{comment:'Construction crews have been out and about, but everyone has forgotten about this',poster:'Anonymous'}]} mapEnabled={true}>
                    ...
                    <BulletinRow up={21} down={2} statement={"Neighbors want More Patrols in Neighborhoods"} quotes={[{comment:'I\'ve seen cars come through that aren\'t from our neighborhood',poster: 'Timothy F.'}]} mapEnabled={true}>
                    ...
                    <BulletinRow up={5} down={52} statement={"Neighbors want Higher Property Taxes"} quotes={[{comment:'I have too much money; I wouldn\'t mind paying more :)',poster: 'Angel M.'},{comment:'This has to be a joke... right?',poster: 'Kelly H.'}]} mapEnabled={false} />

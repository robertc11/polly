...
export default function tailwindTest(){
    return (
        <>
            ...
            <div id="navWrapper" class="w-full bg-white sticky top-0">
            ...
            <div id="mainBlock" class="rounded-lg flex flex-col justify-center items-center mx-auto shadow-lg bg-violet-100 w-2/3 mb-10 p-5 font-dongji">
            ...
            <div id="introBlock" class="rounded-lg flex mx-auto shadow-lg bg-violet-100 w-2/3 mb-10 font-dongji">
            ...
            <div id="cardsBlock" class="rounded-lg flex flex-col justify-center items-center mx-auto shadow-lg bg-violet-100 w-2/3 p-5 font-dongji mb-10">
            ...
            <div id="bulletinBlock" class="rounded-lg flex flex-col justify-center items-center mx-auto shadow-lg bg-violet-100 w-2/3 p-5 font-dongji mb-10">
                <h1 class="text-2xl">Work together to improve your community</h1>

                <details class="mt-5 w-4/5 text-center bg-white open:ring-1 open:ring-black/5 p-6 rounded-lg" closed>
                    <summary class="text-sm leading-6 text-gray-900 dark:text-slate-600 font-semibold select-none"><span class="font-bold text-emerald-400">15</span> Neighbors want to Fix the Pothole on 5th and Main</summary>
            ...
            <footer class="flex justify-center items-center relative bottom-0 w-full text-white">
                <div id="footerWrapper" class="p-1 flex justify-center items-center w-2/3 bg-violet-400 mx-auto relative text-center rounded-t-md">
                    <h1 class="text-white font-bold text-2xl mr-2 select-none">Polly</h1>
                    <h1 class="text-2xl"> | </h1>
                    <p class="ml-2">Created with Wix</p>
